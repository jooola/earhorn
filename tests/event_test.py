...
def test_event_json():
    assert (
        ...
        == """{"when":"2022-08-16T19:01:36.791399","name":"silence","kind":"start","seconds":"0","duration":null}"""
    )
    assert (
        SilenceEvent(
        ...
        == """{"when":"2022-08-16T19:01:39.361082","name":"silence","kind":"end","seconds":"4.57095","duration":"4.57095"}"""
    )
